...
Object.entries(enteredValue).forEach(([key, value]) => {
        ...
        <div className="flex w-full max-lg:flex-wrap justify-between lg:mt-4 p-1">
          <div className="px-2 mt-5 lg:px-3 xl:px-4 mb-10 lg:mb-0 flex w-fit lg:order-1 justify-center items-center lg:w-5/16 order-2">
            ...
            <div className="w-full relative pr-5 | lg:max-w-sm | lg:pr-0  mb-5 flex flex-col items-start justify-center">
              ...
              Have a question or an idea in mind? Fill out the form to assign your project or click on connect to get in touch .Let’s work together to bring your vision to life <span className="text-2xl text-emerald-500">!</span>
              </p>
              <a href="/contact" className="  inline-flex relative group outline-none  | focus:outline-none "><div className="w-auto bg-emerald-300 inline-flex items-center justify-center relative leading-tight shadow-none overflow-hidden rounded-full border-default text-gray-600 py-2 px-5"><div className="relative inline-flex items-center justify-center top-px flex-shrink-0 bg-emerald-300"><div>
                Connect</div></div></div><div className="bg-emerald-300 flex-shrink-0 overflow-hidden flex items-center justify-center -ml-1 rounded-full transform transition-transform | w-9 h-9 | xl:group-hover:translate-x-3  xl:group-hover:rotate-45 | js-button-icon"><GoArrowUpRight /></div></a>
            </div>
