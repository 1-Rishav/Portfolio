      ...
      <div className="relative w-full " >
        <div
          ...
          <div
            ...
            className={cn(
              "absolute right-0  z-[1000] h-auto box w-[5%] overflow-hidden bg-gradient-to-l "
            )}></div>
<div >
        ...
        <div className="fixed inset-0 h-screen z-40 overflow-auto ">
          ...
          <motion.div
            ...
            <button
              ...
              onClick={handleClose}>
              <RxCross2 className="h-6 w-6 text-emerald-700 dark:text-neutral-900" />
            </button>
            <motion.p
              layoutId={layout ? `category-${card.title}` : undefined}
              className="text-lg font-semibold text-emerald-400 dark:text-white">
              {card.category}
            </motion.p>
            <motion.p
              layoutId={layout ? `title-${card.title}` : undefined}
              className="text-2xl md:text-5xl font-semibold text-emerald-700 mt-4 dark:text-white">
              {card.title}
            </motion.p>
    ...
    <motion.button
      ...
      <div className="relative z-40 p-8">
        <motion.p
          ...
          className="text-emerald-500 text-sm md:text-base font-medium font-sans text-left">
          {card.category}
        </motion.p>
        <motion.p
          layoutId={layout ? `title-${card.title}` : undefined}
          className="text-emerald-700 text-xl md:text-3xl font-semibold max-w-xs text-left [text-wrap:balance] font-sans mt-2">
          {card.title}
        </motion.p>
      </div>
