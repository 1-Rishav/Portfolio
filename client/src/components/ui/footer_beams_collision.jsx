...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "sm:h-[87vh] md:h-[25rem] top-28 left-4 rounded-lg bg-gradient-to-b from-neutral-950 to-neutral-800 dark:from-neutral-950 dark:to-neutral-800 relative flex items-center w-[98%] justify-center overflow-hidden",
