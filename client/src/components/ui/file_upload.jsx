              ...
              <motion.div
                ...
                {isDragActive ? (
                  <motion.p
                    ...
                    Drop it
                    <MdOutlineFileUpload className="h-4 w-4 text-emerald-500 dark:text-neutral-400" />
                  </motion.p>
                ) : (
                  <MdOutlineFileUpload className="h-4 w-4 text-emerald-500 dark:text-neutral-300" />
                )}
              </motion.div>
            )}
